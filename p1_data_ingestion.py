...
def ingest_to_aws(START_DATE):
    ...
    # Upload selected ticker list
    ticker_table_df = ticker_table()
    upload_df(ticker_table_df, "ticker_list")
    ...
    upload_df(df_all_currencies, "crypto_data")

    # Upload sentiment data
    df_sentiment = fetch_sentiment_data()
    upload_df(df_sentiment, "sentiment_data")
